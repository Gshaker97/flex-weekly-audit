  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h2 className="mt-2 text-2xl font-semibold tracking-tight">Uninvoiced Revenue</h2>
      ...
      <Card>
        ...
        <CardContent>
          {jobs.length === 0 ? (
            <p className="text-sm text-muted-foreground">All completed jobs are invoiced. 🎉</p>
          ) : (
